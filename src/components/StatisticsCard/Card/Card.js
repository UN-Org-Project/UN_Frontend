      ...
      >
        ...
        <div className="flex flex-row justify-between pb-3">
          <div className="flex flex-col">
            <h3 className="text-title-md font-bold">{props.cardName}</h3>
          </div>
        </div>
        <div className="flex flex-row justify-between py-3">
          ...
          <h1 className="self-center text-title-xxl font-bold">
            {props.statistics ? props.statistics : 0}
          </h1>
          <p className="font-bold text-title-xxl">{props.statName}</p>
        </div>
      </div>
