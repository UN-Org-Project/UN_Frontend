...
const Card = (props) => {
  const green = "text-indigo-100 bg-green-500  ";
  const blue =
    "bg-clip-border bg-gradient-to-tr from-blue-600 to-blue-400 shadow-blue-500/40";
  return (
    <>
      <div className="flex-shrink max-w-full px-4 w-full sm:w-1/2 lg:w-3/4 mb-6">
        <div
          className={`${
            props.isGreen ? green : blue
          } text-white  shadow-lg rounded-lg  h-full p-6 relative overflow-hidden`}>
