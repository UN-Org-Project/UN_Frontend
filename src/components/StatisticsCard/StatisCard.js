  ...
  return (
    <div className="flex flex-wrap flex-row justify-center mt-5">
      <div className="flex-shrink max-w-full px-4 w-full sm:w-1/2 lg:w-1/4 mb-6">
        <div className="text-indigo-100 bg-indigo-500 rounded-lg shadow-lg h-full p-6 relative overflow-hidden">
          ...
          <div className="flex flex-row justify-between py-3">
            ...
            <h2 className="self-center text-2xl font-bold">202</h2>
          </div>
        </div>
      </div>
      <div className="flex-shrink max-w-full px-4 w-full sm:w-1/2 lg:w-1/4 mb-6">
        <div className="text-indigo-100 bg-green-500 rounded-lg shadow-lg h-full p-6 relative overflow-hidden">
          <div className="absolute ltr:-right-8 rtl:-left-8 -bottom-8 text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
