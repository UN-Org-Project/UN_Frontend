...
const Sidbar = (props) => {
  ...
  return (
    <div
      id="sidebar"
      className="flex flex-col h-screen fixed items-center bg-blue-600 md:block shadow-xl px-3  md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out  min-h-screen">
      <div
        id="profile"
