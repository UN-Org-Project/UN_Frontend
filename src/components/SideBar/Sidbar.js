    ...
    >
      ...
      <div className="flex items-center gap-5  py-6 px-8">
        ...
        <div>
          ...
          <span className="block text-xs text-gray">{props.userRoll}</span>
        </div>
        <button
          ref={trigger}
      ...
      <nav className="m-4">
        ...
        <ul className="mb-4 flex flex-col gap-1">
          ...
          {/* <li className="">
            <NavLink
              to="/admin"
              className={` font-sans text-center align-middle  flex items-center gap-4 w-full px-4 py-3 rounded-lg font-bold text-xs text-white center capitalize shadow-md shadow-green-500/20 hover:shadow-lg hover:shadow-green-500/40 transition-all duration-300 disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none active:opacity-[0.85]  dark:hover:bg-meta-4 ${
                (pathname === "/" || pathname.includes("admin")) &&
                " bg-gradient-to-tr from-green-600 to-green-400  dark:bg-meta-4"
              }`}
            >
              <svg
                className="fill-current"
              ...
              <p className="block antialiased text-white leading-relaxed capitalize font-medium text-base font-sans">
                {" "}
                Add Student{" "}
              </p>
            </NavLink>
