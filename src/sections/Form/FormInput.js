      ...
      <div className="">
        <div className="">
          ...
          <div className="border-b-4 border-blue-300">
            <div className=" mt-2 w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              <div className="px-4 pt-3 first-letter:py-2 bg-white rounded-t-lg dark:bg-gray-800">
