  ...
  return (
    <>
      <div class="">
        <div
          id="divider"
          class="rounded-full ring-2 ring-blue-600 lg:w-1/2 lg:mx-auto mt-15"></div>
                ...
                <div className="ext service-item text-center pt-3">
                  <div className="int p-4 ">
                    ...
                    <p className="detaile opacity-60">
                      This system provides administrators with all the tools
                      they need for effective data management, including the
                      ability to assign and enroll users in classes.
                    </p>
                  </div>
                </div>
              </Zoom>
              <Zoom>
                <div className="ext service-item text-center pt-3">
                  <div className="int p-4 ">
                    ...
                    <p className="detaile opacity-60">
                      You always have the ability to track your children's
                      academic performance. Our system helps parents to know
                      their children's level of academic progress, exam grades,
                      and more.
                    </p>
                  </div>
                </div>
              ...
              <Zoom>
                <div className="ext service-item text-center pt-3">
                  <div className="int p-4 ">
                    ...
                    <h5 className=" tiitle mb-3 ">
                      Effective parental involvement
                    </h5>
                    <p className="detaile opacity-60">
                      Teachers can also send messages, behavior and grade
                      reports, memos, and more to parents so that they can keep
                      track of their children's performance and academic
                      progress
                    </p>
                  </div>
                </div>
              ...
              <Zoom>
                <div className="ext service-item text-center pt-3">
                  <div className="int p-4 ">
                    ...
                    <p className="detaile opacity-60">
                      The system allows parents and teachers to engage in
                      real-time conversations regarding their child's progress,
                      academic performance, behavior, and other important
                      updates.
                    </p>
                  </div>
                </div>
