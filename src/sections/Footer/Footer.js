...
const Footer = () => {
  return (
    <footer id="contact" aria-label="Site Footer" className=" bg-blue-500">
      <div className="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center">
          <h2 className="text-3xl font-extrabol  text-white sm:text-5xl">
            Student Tracking System
          </h2>

          <a
            href="#"
            className="inline-block px-12 py-3 mt-8 text-sm font-medium text-white border border-white rounded-full bg-green-400 hover:bg-green-800 hover:text-white focus:outline-none focus:ring active:bg-green-500">
            Contact Us
          </a>
        </div>
          ...
          <nav aria-label="Footer Navigation - Support">
            <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
              <li>
                <a
                  href="/"
                  className="text-white transition hover:opacity-75 dark:text-gray-400">
                  Home
                </a>
              </li>
    ...
    // </div>
    // <>
    //   <footer class="bg-color-footer dark:bg-gray-900 pt-10">
    ...
    //               Resources
    //             </h2>
    //             <ul class="Tailwind CSS  dark:text-gray-400">
    //               <li class="mb-4">
    ...
    //         Developed with Love ❤️ By Muath | Ahmad | Yaseen | Mohammad <br />
    //         <a href="/#">Copyright © 2023</a>
