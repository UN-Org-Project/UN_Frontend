    ...
    <footer aria-label="Site Footer" class=" bg-blue-500">
      <div class="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div class="text-center">
          ...
          <a
            href="#"
            class="inline-block px-12 py-3 mt-8 text-sm font-medium text-white border border-white rounded-full bg-green-400 hover:bg-green-800 hover:text-white focus:outline-none focus:ring active:bg-green-500"
          >
            Contact Us
          </a>
        </div>

        <div class="pt-8 mt-16 border-t border-gray-100 dark:border-gray-800 sm:flex sm:items-center sm:justify-between lg:mt-24">
